...
- **More lists** (2026-09-24): lists beside Now / Next / Later / Done on the Tasks page, e.g. **Someday**, or one per client, for remote work for many clients that isn't tied to a day (day-only tasks, §4.2a, cover onsite work).
